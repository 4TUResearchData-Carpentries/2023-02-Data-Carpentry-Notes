...
```{r}
interviews_plotting %>%
ggplot(aes(x = rooms, y = village, col = respondent_wall_type)) + # col to add color to the framework, each wall type in other color
geom_count(
alpha = 0.3,
)

interviews_plotting %>% ggplot(aes(x = rooms, y = village, colour = respondent_wall_type)) + geom_count() 
```
